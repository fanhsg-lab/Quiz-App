...
import static com.example.duolingo.DbQuery.loadquestions;
...
public class StartTestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadquestions(new MyCompleteListener() {
            ...
            public void onFailure() {
                ...
                progressDialog.dismiss();
                Toast.makeText(StartTestActivity.this,  "Somethink went wrong ! Please try Again",
    ...
    private void setData()
    {
        ...
        Log.d("que1", "mphka " + g_catList.get(DbQuery.g_selected_cat_index).getName() + "Test No. " + String.valueOf(DbQuery.g_quesList.size()) );
    }
